...
# VARIALBES                                              #
##########################################################
InputFile = "C:/RData/RiceChrom12.txt"                                  # Input file of spatial data
OutputFileSummary = "C:/RData/RiceChrom12AnalysisSummary.txt"           # Export file name for the summary of the analysis
OutputFileValues = "C:/RData/RiceChrom12AnalysisIValues.txt"            # Export file name for the entire set of permuted I values
